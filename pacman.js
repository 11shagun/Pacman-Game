 let board;
        ...
        function loadImages(callback) {
            ...
            function createImage(path, assign) {
                const img = new Image();
                img.onload = onLoad;
            ...
            wallImage       = createImage(sources.wallImage);
            blueGhostImage  = createImage(sources.blueGhostImage);
            orangeGhostImage= createImage(sources.orangeGhostImage);
            pinkGhostImage  = createImage(sources.pinkGhostImage);
            redGhostImage   = createImage(sources.redGhostImage);
            pacmanUpImage   = createImage(sources.pacmanUpImage);
            pacmanDownImage = createImage(sources.pacmanDownImage);
            pacmanLeftImage = createImage(sources.pacmanLeftImage);
            pacmanRightImage= createImage(sources.pacmanRightImage);
        }
